...
External dependencies are requirements outside of the scope of control of the development project necessary for the HUMS to be run successfully. The previous report did not consider the external dependencies pertaining to the Consumer running the HUMS, as well as those of the development process, so they are considered here.
 ...
 \item[\ed{2}] Any necessary network or firewall configuration must be performed to allow Clients to communicate with the Core where necessary.
  \item[\ed{3}] The selected remote data stores must have a high enough availability to meed the non-functional requirements of the HUMS set out earlier.
 \end{description}
...
Having evaluated our solution against the requirements, we must also consider our quality attribute scenarios, designed to test the systems ability to provide the desired responses in interesting contexts. Table~\ref{tab:qasEval} shows the expected responses of our included quality attribute scenarios, and the actual response of the prototype. 

...
\xtableformat{ p{1.3cm}  X X }{ 
	...
	FR.3  & To meet the requirement to store correctly structured data, we have enforced checks on data entering the core. The data is stored in a Datastore. This is H2 for a local Datastore, and is a PostgreSQL instance on Heroku for the cloud solution. 	  & 	 \\ 

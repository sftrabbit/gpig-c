...
Using iotop under Ubuntu 14.04 we were able to verify that the test application did not perform any IO operations. Using Wireshrak under Linux no network activity was detected

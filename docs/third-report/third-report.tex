...
\label{sec:summary}
\hl{TODO All}
This report has set the details for the design and development of our HUMS progress, and in particular highlights the changes and progression from the previous report. The main addition for requirements were the set of external dependencies and the design of the system architecture.

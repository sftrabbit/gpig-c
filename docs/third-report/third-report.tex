...
\subsection{Store}
\label{sec:store}
To improve the tailorability of the system and address risks \emph{R.6} and \emph{R.7}, three different datasources were supported. Two remote data sources, Google app engine and a Postgres instance hosted on Heroku or a local H2 instance. Clients can change between datasources with ease by updating their configuration file.

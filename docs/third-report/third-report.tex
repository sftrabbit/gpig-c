...
Our use of the SWT library for building the user interface cost a surprising amount of time because of the need to bundle the appropriate native binaries for each platform, complicating the build process. Whilst we were pleased with the final result, this added complication may not have been worth the time spent on it.

...
Word count: 11975 (\textit{using TeXCount, excluding small table entries})
\vspace*{0.1cm}
...
The source code of the HUMS implementation developed for this report can be viewed at \url{https://github.com/sftrabbit/gpig-c-public} and the distribution is available at \url{https://github.com/sftrabbit/gpig-c-public/releases}. The prototype SaaS website is available at \url{http://www.gpigc.co.uk/} (username: \texttt{gpigc}, password: \texttt{moustache}).
...
We maintained communication with the Customer throughout this phase, with emails exchanged every few weeks. The first feedback received from the Customer came from the Interim Report and a face-to-face meeting with the Customer. The Customer gave us a number of areas to work on for this report, including better explaining how we considered risks, how we could improve the presented views of our System architecture, and explicitly stating our quality attribute scenarios. This feedback has been clearly acted upon in this report.

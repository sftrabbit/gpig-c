...
\begin{figure}[ht]
  ...
  \caption{Module diagram of the System. Component within the \textbf{blue} areas are included with the HUMS. The  \textbf{green} components are those which can be added by the Consumer to extend the HUMS to meet their needs.}
  \label{fig:modules}
\end{figure}

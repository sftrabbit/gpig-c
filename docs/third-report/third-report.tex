...
\xtableformat{ p{1.3cm}  X X }{ 
	...
	FR.12  & Class files for new analysis engines with correct namespace in JAVA were moved into the engines folder of the HUMS at run time. & The HUMS automatically loaded the new engines and started using them. \\ 

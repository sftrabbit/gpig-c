...
\label{sec:qualities}
Quality attributes must be considered when designing the HUMS architecture to ensure that architectural decisions not only provide the desired functionality, but also result in a system meeting the quality requirements of all stakeholders.

...
\source{The Consumer}
\stimulus{The Consumer wishes to modify the HUMS behaviour, to use new engines and update their configuration file.}
\artifact{HUMS Core, Configuration File}
\environment{Runtime/Compile Time}
\response{The Consumer is able to add new engines and modify the configuration files.}
\measure{ The HUMS is not re-installed or re-compiled}
\rationale{This scenario is important to the customer, as they expect the Consumer to be able to easily add functionality specific to their industry. Achieving this scenario will help our solution to move across different domains easily.}
\end{scenario}

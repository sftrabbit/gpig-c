...
\fr{4} & Yes & The refinements of this requirement were verified through testing, and a snapshot of the configuration file format used is shown in Figure~\ref{fig:configFiles}. \\
\fr{5} & No & Due to timing constraints, we chose not to implement storage limits, for our SaaS distribution of the HUMS, as part of this prototype. In the future this requirement would be verified by defining a storage limit through the Admin Centre and attempting to store more data.\\
\fr{6} & No & \\
\fr{7} & Yes & \\
\fr{8} & Partial & \\
\fr{9} & Yes & \\

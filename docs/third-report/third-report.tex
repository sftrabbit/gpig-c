...
\section{Glossary}
\label{sec:glossary}
\hl{TODO: Possibly update this - add something about data stores too?}
...
The quality attributes laid out in Section \gl{sec} have been largely satisfied. The requirement that the HUMS system be utilisable in multiple domains was emphasised strongly, and so high flexibility was a goal from the beginning of the project. 

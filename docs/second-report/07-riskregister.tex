...
\begin{longtable}[H]{| p{0.65cm} | p{2cm} | p{0.3cm} | p{0.3cm} | p{2.4cm} | p{3cm} | p{2.7cm} | p{0.4cm} |}
  ...
  & Refocus team, working on the agreed functionality and requirements.
  & \\
  ...
  \hline \textbf{R.7}
  & Short team failure of communication link to Google App Engine
  & 3
  & 4
  & Short term loss of service to users, loss of confidence in the system
  & A final commercial version would use the premium Google service which guarantees an uptime of at least 99.95\% (\nfrit10)
  & Additional data abstraction layer could be built to interface with another database service if App Engine proves to be unreliable
  & \\

  \hline \textbf{R.7}
  & Prolonged failure of communication link to Google App Engine 
  & 5
  & 2
  & Prolonged loss of service to users, loss of confidence in the system, possible failure to meet \nfrit10 and \nfrit13
  & As above
  & As above
  & \\

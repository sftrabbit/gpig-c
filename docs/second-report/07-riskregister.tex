...
A risk assessment has been performed, based on the design decisions made throughout the initial and interim phases of the project, ensuring team members are aware how to react to problems when they occur.

After feedback from the Customer we took extra time to ensure both technical and procedural risks were identified early on.

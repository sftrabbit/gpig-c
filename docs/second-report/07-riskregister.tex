...
\begin{longtable}[H]{| p{0.65cm} | p{2cm} | p{0.3cm} | p{0.3cm} | p{2.7cm} | p{3cm} | p{2.6cm} | p{0.4cm} |}
  \hline
  ...
  \hline \textbf{R.6}
  & Communications link to Google AppEngine fails.
  & 3
  & 4
  ...
  & Reengineer HUMS, possibly switching datastore.
  & 10\\
  ...
  & Research different software and hardware ensuring chosen technologies  allow performance requirements to be met.
   & Optimise code.
  ...
  \hline \textbf{R.11}
  & Analysis components computing incorrect values.
  & 2
  & 5

...
of the system to allow for explicit feedback: the output of analysis can affect the monitored system. 
	 ...
	 \begin{description}
		 ...
		 \item[\fr{4.2}] The HUMS shall allow the consumer to define a 	
		  ...
		  \item[\fr{4.4}]  The HUMS shall allow the user to define that, 	
			...
			no longer added.
		 \item[\fr{4.5}] The HUMS shall allow the user to de- fine that, 
...
\nfrit{6} has been refined to more concretely detail the testing strategies to 

...
\begin{figure}[ht!]
  ...
  \includegraphics[width=9.5cm]{images/DataInputLayer/
ProtoMultiReceiver.png}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width= 9.5cm]{images/DataAbstractionLayer/
systemDataGateway.png}
  \includegraphics[width= 5cm]{images/DataAbstractionLayer/
dataJsonAttribute.pdf}
  ...
  \includegraphics[width= 9cm]{images/DataAbstractionLayer/
emitterSystemState.pdf}

...
rolling average of each value, and causes an email to be sent if this value
becomes too high. The raw values are read by the reporting system and 
displayed live in the admin centre, \hl{as shown in} figure~\ref{fig:graphing}. %% the current screenshot is of Nyan cat not of the test application!
...
detected earthquakes on a map of the world in the admin centre, as shown in figure~\ref{fig:plotearthquakes}.

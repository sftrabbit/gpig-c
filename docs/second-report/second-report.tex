...
\begin{figure}[ht!]
\centering
\includegraphics[width= 5cm]{images/DataAbstractionLayer/packageDiagram.png}
\caption{Package diagram of the data abstraction layer}
...
\begin{figure}[ht!]
\centering
\includegraphics[width= 7.5cm]{images/DataAbstractionLayer/systemDataGateway.png}
\includegraphics[width= 7cm]{images/DataAbstractionLayer/queryResult.pdf}
\includegraphics[width= 8cm]{images/DataAbstractionLayer/sensorState.pdf}
\includegraphics[width= 6.5cm]{images/DataAbstractionLayer/dataJsonAttribute.pdf}

\caption{Conceptual diagrams of the classes within the data abstraction layer}
\label{fig:dataAbstractionPackage}
\end{figure}

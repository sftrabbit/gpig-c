...
All running Customer Test Application or Earthquake Monitor instances will send data to the same HUMS instance, and so data from multiple instances of the same example application will be interleaved in the admin centre live view. With this in mind, we recommend only running one instance of each application at a time.

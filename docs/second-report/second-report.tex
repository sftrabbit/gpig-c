...
\begin{figure}[!ht]
  ...
  \caption{The module diagram of the HUMS. Green components are those developed as part of the GPIG-C system. Blue components have default implementations provided as part of GPIG-C, but may be replaced or added to by the consumer.}

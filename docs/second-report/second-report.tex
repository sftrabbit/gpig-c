...
\newcommand{\specialcell}[2][l]{\begin{tabular}[#1]{l@{}l@{}}#2\end{tabular}}
...
\begin{longtable}[H]{| p{1.5cm} | p{5cm}| p{2.5cm}| p{2.5cm}|}
  \hline\rowcolor{titleColor} \textbf{Req. ID} & \textbf{Test Classes} & \textbf{Type} & \textbf{Cases}\\
  \hline \fr{3.1}   & GWTSystemDataGatewayTest & Unit & Extreme values\\
  \hline \fr{3.2}   & SystemDataTest,\newline EmitterSystemStateTest,\newline QueryResultTest & Unit &\\
  \hline \fr{7.2}   & ExpressionAnalysisTest  &a &\\
  \hline \fr{11}    & EmailNotificationTest  & Inspection &\\
  \hline
\end{longtable}

...
of the project the admin centre will be functional.

\subsection{Source}
The source for our prototype implementation can be accessed online at \verb
+http://git.gpigc.co.uk+ and cloned using Git from \verb+http://git.gpigc.co.uk/
gpig-c.git+. The username required is \verb+gpigc+ with the password \verb
+moustache+.

...
\title{\vspace{-2cm}GPIG-C Interim Report\vspace{-0.7cm}}
\author{Word count: \input{wc}\footnote{\textit{Using TeXCount, excluding\ldots}}}
\date{\vspace{-0.6cm}\fontsize{7}{6pt}Friday, 14th February 2014}
\maketitle
\vspace{-0.9cm}
\rule{\textwidth}{0.4pt}
\vspace{-0.3cm}
...
\section{Use cases}
Three use cases were identified after initial communications with the customer
and were used to generate requirements. 
...
structured as simply and concisely as possible and has been worded in such a way
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{images/system-architecture.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width =21cm, trim=4cm 2cm 0cm 1.5cm]{images/gantt}

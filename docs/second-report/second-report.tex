...
to query the heap usage, as the operating system would just report the size of 
the JVM heap. We settled on using Sigar for process monitoring, and JMX for

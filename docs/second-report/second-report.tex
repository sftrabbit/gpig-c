...
Currently there are two data emitters built in to the system, demoing its flexibility, the first extract and emits data about the JVM, recording CPU and memory usage, the second extracts and emits live data about earthquake activity from the USGS earthquake hazards program API \cite{usgs}.

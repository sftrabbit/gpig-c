...
\begin{description}
  \item[Data Emitter] As the purpose of the data emitter is to run
    ...
    inspection testing to verify that data was reported, fulfilling \frit{1.2},
    \frit{1.3}, and \frit{1.4} along with running the program for several hours to
  ...
  \item[Data Abstraction Layer] Given the high throughput and
    ...
    performance. We completed an inspection test to verify \frit{3.1}, 
    and used the GWTSystemDataGatewayTest class 
    to verify \frit{4.2}. At the unit testing level, as 

...
\subsubsection{Windows}
To launch the core on Windows, navigate to the directory in Windows Explorer where \texttt{EmitterLauncher.jar} file is located. The core can be launched by double clicking on the \texttt{EmitterLauncher.jar} file. This will launch the HUMS.
\subsubsection{Linux}
To launch the core on linux, using the terminal, navigate to the directory where \texttt{EmitterLauncher.jar} is located. The HUMS can then be launched with the command:
\begin{center}
...
\subsubsection{OS X}
To launch the core on OS X, using the terminal, navigate to the directory where EmitterLauncher.jar is located. The HUMS can then be launched utilising the command:
\begin{center}

...
\author{Word count: \input{wc} (\textit{Using TeXCount, excluding all tables and figures except the Risk Register})}
...
\begin{figure}[hptb}
	\centering
	\includegraphics[width=\textwidth]{pdf-images/riskass-table.pdf}
	\caption{Impact and Probability Score}
	\label{fig:ipScore}
\end{figure}

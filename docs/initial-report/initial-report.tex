...
\author{Word count: \input{wc}\footnote{\textit{Using TeXCount, excluding all tables and figures except the Risk Register}}}
\date{\vspace{-0.6cm}\fontsize{7}{6pt}Friday, 25th October 2013}
\maketitle
\vspace{-0.4cm}
\hline 
% This line breaks the compilation for me (TD) on OSX

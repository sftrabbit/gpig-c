...
public class HerokuSystemDataGatewayTest {
	...
	@Before
	public void setUp() throws ClassNotFoundException, URISyntaxException, SQLException {
	...
	public void testBulkWrite() throws FailedToWriteToDatastoreException, SQLException, FailedToReadFromDatastoreException {
		...
		emmitterSystemStates.add(new EmitterSystemState(testSystemID, new Date(), payload));
